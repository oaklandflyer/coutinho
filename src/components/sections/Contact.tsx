  ...
  return (
    ...
    >
      <div className="w-full max-w-3xl">
        ...
        <h2 className="reveal d1 font-display text-[clamp(3rem,7vw,8rem)] leading-none tracking-[0.04em] text-ink mb-4">
          Let&apos;s build
          <br />
          <span className="text-amber">something.</span>
        </h2>

        <p className="reveal d2 font-body font-light text-[0.85rem] text-ink/40 leading-loose mb-10 max-w-sm mt-8">
        ...
        <div className="reveal d3 flex flex-col gap-2 max-w-sm">
          {links.map((l) => (
            <a
              ...
              className="flex items-center justify-between px-4 py-3.5 border border-ink/[0.08] hover:border-sky/30 hover:bg-sky/[0.03] transition-all duration-200 group"
            >
              <span className="font-body font-light text-[0.82rem] text-ink/55 group-hover:text-ink/85 transition-colors duration-200">
                {l.label}
              </span>
              <span className="font-mono text-[0.46rem] tracking-[0.1em] text-ink/22 group-hover:text-sky/50 transition-colors duration-200">
                {l.sub} ↗
              </span>
            </a>
          ))}
